...
export const metadata = {
  ...
  description: "Learn about the heritage, craftsmanship, and commitment to quality behind Bansighar Enterprise, custom furniture makers.",
};
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <p className="text-luxury-muted leading-relaxed">
              Bansighar Enterprise was born out of a desire to rescue authentic wood craftsmanship from the rush of mass-manufactured, short-lived furniture. In an era dominated by flat-pack boards and plastic laminates, we set out to build furniture that increases in value, character, and beauty as it ages.
            </p>
            <p className="text-luxury-muted leading-relaxed">
            ...
            <p className="text-luxury-muted leading-relaxed">
              Today, Bansighar Enterprise represents a community of 25 master carpenters, carvers, and designers who share one singular focus: absolute woodworking excellence.
            </p>
          </div>

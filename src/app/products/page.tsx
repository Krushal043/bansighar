...
function ProductsContent() {
  const productsData: Product[] = [
    ...
    {
      id: "kitchen-luxe",
      name: "Luxe Modular Kitchen Cabinets",
      category: "Dining",
      price: "Inquire for pricing",
      image: "/images/kitchan_1.jpeg",
      rating: 5,
      description: "Custom modular kitchen layout with premium soft-close drawer slides, space-efficient corner pull-outs, and sleek high-gloss anti-scratch laminate.",
      specs: {
        materials: "Waterproof marine plywood, quartz countertops, premium fittings",
        dimensions: "Custom-fitted to kitchen layout",
        finish: "Scratch-resistant acrylic & chrome detailing",
      },
    },
    {
      id: "kitchen-island",
      name: "Royal Kitchen Island & Pantry",
      category: "Dining",
      price: "Inquire for pricing",
      image: "/images/kitchan_2.jpeg",
      rating: 5,
      description: "A functional and aesthetic centerpiece for contemporary culinary spaces. Features double-thick quartz overhang and rich walnut drawer fronts.",
      specs: {
        materials: "Solid walnut frames, Carrara quartz surface, brass pulls",
        dimensions: "96\" W x 42\" D x 36\" H (Customizable)",
        finish: "Food-safe natural oils & polished stone",
      },
    },
    {
      id: "bed-boutique",
    ...
    {
      id: "bed-heritage",
      name: "Heritage Teak Bed Suite",
      category: "Bedroom",
      price: "Inquire for pricing",
      image: "/images/badroom_2.jpeg",
      rating: 5,
      description: "Hand-finished seasoned teak frame highlighting majestic grains, detailed joinery, and a floating profile.",
      specs: {
        materials: "Seasoned Indian Teak, heavy-duty internal frame structure",
        dimensions: "King Size (82\" W x 88\" D x 45\" Headboard H)",
        finish: "Traditional hand-sanded teak oil finish",
      },
    },
    {
      id: "bed-contemporary",
      name: "Contemporary Luxury Bed",
      category: "Bedroom",
      price: "Inquire for pricing",
      image: "/images/badroom3.jpeg",
      rating: 5,
      description: "Upholstered luxury bedframe featuring a towering velvet-tufted headboard and integrated floating nightstands.",
      specs: {
        materials: "Multi-layer plywood frame, high-density comfort backing, luxury velvet",
        dimensions: "Queen / King sizes available",
        finish: "Stain-resistant velvet protectant",
      },
    },
    {
      id: "wardrobe-elite",
      name: "Elite Modular Wardrobe",
      category: "Bedroom",
      price: "Inquire for pricing",
      image: "/images/bardboard.jpeg",
      rating: 5,
      description: "Integrated walk-in wardrobe system with modular shelving, LED-lit glass drawers, and custom-finished pull-out racks.",
      specs: {
        materials: "Premium MDF core, tempered glass doors, anodized aluminum frames",
        dimensions: "Customized to wall height & width",
        finish: "Textured oak veneer & powder-coated bronze",
      },
    },
    {
      id: "wardrobe-sliding",
      name: "Royal Sliding Cupboard",
      category: "Bedroom",
      price: "Inquire for pricing",
      image: "/images/bardbaord_2.jpeg",
      rating: 5,
      description: "Floor-to-ceiling space-saving sliding wardrobe with premium tinted mirror panels and acoustic runners.",
      specs: {
        materials: "Engineered hardwood base, double-track sliding system, safety-backed glass",
        dimensions: "120\" W x 24\" D x 108\" H (Customizable)",
        finish: "Matte carbon lacquer & tinted bronze mirror",
      },
    },
    {
      id: "desk-executive",
